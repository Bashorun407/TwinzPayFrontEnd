          ...
          <div key={monthDate.toISOString()} className="w-full max-w-72 space-y-2">
            <div className="flex w-full items-center justify-between gap-x-4">
              {isFirstMonth ? (
                <button
                  className={cn(
                    "grid size-7 place-items-center rounded border border-gray-400 transition-opacity",
            ...
            <div className="grid w-full grid-cols-7 gap-x-1">
              {DAYS_OF_WEEK.map((day) => (
                <div
                  key={day}
                  className="flex aspect-square items-center justify-center text-sm font-medium text-gray-500"
                >
                  {day}
                </div>
              ))}
                  ...
                  >
                    <button
                      className={cn(
                        ...
                        day && !disabled && !selected && "hover:bg-gray-300",
