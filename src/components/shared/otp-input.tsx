      ...
      <div className="flex items-center justify-center gap-3">
        {values.map((value, index) => (
          <MemoizedInput
            ...
            className="focus:border-primary-500 text-primary-500 flex aspect-square size-11 shrink-0 items-center justify-center rounded-md border bg-white px-3 py-2 text-center text-lg font-medium uppercase outline-none select-none read-only:border-gray-300 focus:border-2 disabled:border-gray-300"
            disabled={disabled}
            key={index}
            maxLength={length}
