          ...
          <PopoverTrigger asChild>
            <div className="flex items-center gap-x-2">
              <button
                ...
                disabled={disabled}
                className={cn(
                  "flex h-10 flex-1 items-center justify-between gap-x-2 rounded-md border border-gray-300 bg-white px-3 text-sm transition-colors",
                  "focus:border-primary-500 focus:ring-primary-500/20 hover:border-gray-400 focus:ring-2 focus:outline-none",
                  disabled && "cursor-not-allowed opacity-50",
                  !fromDisplay && "text-gray-400",
                )}
              >
                <span className="truncate">{fromDisplay || placeholderFrom}</span>
                <RiCalendar2Line className="size-4 shrink-0 text-gray-500" />
              </button>
      ...
      <Popover>
        <PopoverTrigger asChild>
          <button
            ...
            disabled={disabled}
            className={cn(
              "flex h-10 w-full items-center justify-between gap-x-2 rounded-md border border-gray-300 bg-white px-3 text-sm transition-colors",
              "focus:border-primary-500 focus:ring-primary-500/20 hover:border-gray-400 focus:ring-2 focus:outline-none",
              disabled && "cursor-not-allowed opacity-50",
